<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="correo" class="form-control @error('correo') is-invalid @enderror" value="{{ old('correo', $registro?->correo) }}" id="correo" placeholder="Correo">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="contrasena" class="form-control @error('contrasena') is-invalid @enderror" value="{{ old('contrasena', $registro?->contrasena) }}" id="contrasena" placeholder="Contrasena">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <input type="text" name="edad" class="form-control @error('edad') is-invalid @enderror" value="{{ old('edad', $registro?->edad) }}" id="edad" placeholder="Edad">
